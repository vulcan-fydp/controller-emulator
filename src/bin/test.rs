...
fn main() {
    ...
    let mut procon_1 = ns_procon::NsProcon::create("/dev/hidg0", [255, 0, 0]);
    ...
    for _i in 0..100 {
        let _ = procon_1.press(ns_procon::inputs::BUTTON_A, true);
        ...
        let _ = procon_1.release(ns_procon::inputs::BUTTON_A, true);
